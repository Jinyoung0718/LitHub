...
public class MyPageController {
    ...
    @GetMapping("/me")
    public BaseResponse<MyPageResponseDTO> getMyProfile(@AuthenticationPrincipal UserPrincipal userPrincipal) {
        MyPageResponseDTO myPageResponseDto = myPageService.getCachedMyPageData(userPrincipal.getUserId());
