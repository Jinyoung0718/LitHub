...
public class CommentController {
	...
	public BaseResponse<CommentResponseDTO> createComment(
		...
		return BaseResponse.success(commentService.createComment(postId, request, isPopular));
	}
	...
	public BaseResponse<CommentResponseDTO> updateComment(
		...
		return BaseResponse.success(commentService.updateComment(commentId, request, isPopular, postId));
	}
	...
	public BaseResponse<Empty> deleteComment(
		...
		commentService.deleteComment(commentId, isPopular, postId);
